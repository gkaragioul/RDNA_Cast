...
if(OBS_AMD_LITE)
  set(OBS_PLUGIN_DESTINATION rdna-plugins/64bit)
  set(_obs_lite_plugin_subdir rdna-plugins)
else()
  set(OBS_PLUGIN_DESTINATION obs-plugins/64bit)
  set(_obs_lite_plugin_subdir obs-plugins)
endif()
...
set(OBS_PLUGIN_PATH "../../${CMAKE_INSTALL_LIBDIR}/${_obs_lite_plugin_subdir}/64bit")
