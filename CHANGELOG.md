...
### Fixed
- Update checker now uses `gkaragioul/RDNA_Cast` as the canonical GitHub endpoint, eliminating HTTP 301 redirect failures caused by past username changes.
- Update checker curl call now sets `CURLOPT_FOLLOWLOCATION` so future repository renames or username changes will never break auto-update again.
- All in-app links, installer URLs, README, and changelog updated to `gkaragioul/RDNA_Cast`.
...
### Changed
- Assisted updater now checks releases from `gkaragioul/RDNA_Cast`.
...
[0.7.25]: https://github.com/gkaragioul/RDNA_Cast/releases/tag/v0.7.25
[0.7.24]: https://github.com/gkaragioul/RDNA_Cast/releases/tag/v0.7.24
[0.7.23]: https://github.com/gkaragioul/RDNA_Cast/releases/tag/v0.7.23
[0.7.22]: https://github.com/gkaragioul/RDNA_Cast/releases/tag/v0.7.22
[0.7.21]: https://github.com/gkaragioul/RDNA_Cast/releases/tag/v0.7.21
[0.7.20]: https://github.com/gkaragioul/RDNA_Cast/releases/tag/v0.7.20
[0.7.19]: https://github.com/gkaragioul/RDNA_Cast/releases/tag/v0.7.19
[0.7.18]: https://github.com/gkaragioul/RDNA_Cast/releases/tag/v0.7.18
[0.7.17]: https://github.com/gkaragioul/RDNA_Cast/releases/tag/v0.7.17
[0.7.16]: https://github.com/gkaragioul/RDNA_Cast/releases/tag/v0.7.16
[0.7.15]: https://github.com/gkaragioul/RDNA_Cast/releases/tag/v0.7.15
[0.7.14]: https://github.com/gkaragioul/RDNA_Cast/releases/tag/v0.7.14
[0.7.13]: https://github.com/gkaragioul/RDNA_Cast/releases/tag/v0.7.13
